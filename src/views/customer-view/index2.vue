<template>
  <div id="bodyContainer" class="backgroundStyle" :style="backgroundStyle">
    <el-row :gutter="20">
      <el-col :span="4">
        <div id="box1" class="colBox0 grid-content bg-purple container0 left" >
          <!--<div class="resourceNumber">156</div>-->
          <!--<div class="warning">2</div>-->
          <!--<div class="resourceName">服务器</div>-->
        </div>
      </el-col>
      <el-col :span="4">
        <div id="box2" class="colBox0 grid-content bg-purple container0" >
          <!--<div class="resourceNumber">595</div>-->
          <!--<div class="warning">872</div>-->
          <!--<div class="resourceName">业务</div>-->
        </div>
      </el-col>
      <el-col :span="4">
        <div id="box3" class="colBox0 grid-content bg-purple container0" >
          <!--<div class="resourceNumber">990</div>-->
          <!--<div class="warning">120</div>-->
          <!--<div class="resourceName">存储设备</div>-->
        </div>
      </el-col>
      <el-col :span="4">
        <div id="box4" class="colBox0 grid-content bg-purple container0" >
          <!--<div class="resourceNumber">459</div>-->
          <!--<div class="warning">15</div>-->
          <!--<div class="resourceName">主机设备</div>-->
        </div>
      </el-col>
      <el-col :span="4">
        <div id="box5" class="colBox0 grid-content bg-purple container0" >
          <div class="resourceNumber">556</div>
      ...
      <el-col :span="4">
        <div id="box6" class="colBox0 grid-content bg-purple container0 right" >
          <div class="resourceNumber">99</div>
          <div class="warning">12</div>
          <div class="resourceName">网络设备</div>
        </div>
      </el-col>
    </el-row>
    <el-row :gutter="20">
